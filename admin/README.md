...
- Bandeja: filtros Conversaciones / Sin leer / Ocultos / Todos; por chat botones leído–no leído y ocultar–mostrar (también dentro del chat); "Seleccionar" para aplicar lo mismo a varios o a todos los de la vista. El estado vive en `rinbo.chat_estado` (se traspasó lo leído que antes quedaba en el navegador).
